...
#define EV_MASS_FACTOR          100.0f  /* tune feel: accel_max(m/s^2) ~= EV_MAX_TORQUE_NM / EV_MASS_FACTOR.
                                            Old value (1500) gave ~0.1 m/s^2 at full throttle — imperceptible.
                                            100 gives ~1.5 m/s^2 (NORMAL) / ~1.95 (SPORT). Lower = peppier. */
